...
class HomeController extends Controller
{
    ...
    {
        $query = Product::select('id', 'name', 'image', 'price', 'avg_rating')->take(config('setting.front.home-limit-take'));
        ...
        $trendings = Product::select('id', 'image', 'name', 'price', 'avg_rating')->whereIsTrending(config('setting.trending_product'))->take(config('setting.front.home-trending-limit'))->get();
