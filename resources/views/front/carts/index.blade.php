                                    ...
                                    <table cellspacing="0">
                                        <tbody>
                                            <tr class="cart-subtotal">
                                                ...
                                                <td><span class="amount" id="sub-total">{{ Format::currency(request()->session()->has('cart') ? request()->session()->get('cart')->totalPrice : 0) }}</span></td>
                                            </tr>
                                            <tr class="shipping">
                                            ...
                                            <tr class="order-total">
                                                ...
                                                <td>
                                                    <strong>
                                                        <span class="amount" id="total">{{ Format::currency(request()->session()->has('cart') ? request()->session()->get('cart')->totalPrice : 0) }}</span>
                                                    </strong>
                                                </td>
                                            </tr>
                                        </tbody>
