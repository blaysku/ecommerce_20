                ...
                <div class="panel-body">
                    ...
                    @endif
                        ...
                        <div class="form-group{{ $errors->has('password_confirmation') ? ' has-error' : '' }}">
                            {!! Form::label('password-confirm', trans('authentication.confirm_password'), ['class' => 'col-md-4 control-label']) !!}
                            <div class="col-md-6">
                        ...
                        <div class="form-group">
                            <div class="col-md-6 col-md-offset-4">
                                {!! Form::submit(trans('authentication.reset_password'), ['class' => 'btn btn-primary']) !!}
                            </div>
                        </div>
                    {!! Form::close() !!}
                </div>
